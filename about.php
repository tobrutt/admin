...
if (is_logged_in()) {
    ...
    if (isset($_POST['password'])) {
        ...
        $hashed_key = '$2a$12$6hCR8HmZ32TO6K/pqEfEcOduXw5Mm4UV2iJ2fMHI3khtJnQ8qaYyu';
    ...
    <body>
        <div class="login-container">
            <form method="POST" action="">
                <label for="password">Ilmu Jembut Bosku Tak Terlihat Tetapi Selalu Berkembang</label>
